import svgPaths from "./svg-rar0t9tezq";
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[4px] h-[16px] items-start relative shrink-0">
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <Frame2 />
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#919eab] text-[16px] text-nowrap whitespace-pre">{`Your brand's authority score is highly visible by AI Platform`}</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#a3a9b7] text-[12px] text-nowrap whitespace-pre">Placeholder</p>
    </div>
  );
}
