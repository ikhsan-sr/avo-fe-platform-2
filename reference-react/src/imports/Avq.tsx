import svgPaths from "./svg-b7d2my58f1";
...
function Shade() {
  return <div className="absolute bg-[rgba(0,194,184,0.05)] blur-[100px] filter h-[320px] left-[20px] rounded-[2.68435e+07px] top-[597px] w-[1399.2px]" data-name="Shade" />;
}

function Shade1() {
  return <div className="absolute bg-[rgba(0,194,184,0.05)] blur-[100px] filter h-[320px] left-[20px] rounded-[2.68435e+07px] top-[85.2px] w-[1399.2px]" data-name="Shade" />;
}
...
function Text() {
  return (
    <div className="absolute h-[15.988px] left-[40.39px] top-[34.41px] w-[141.613px]" data-name="Text">
      <p className="absolute font-['Manrope:Bold',sans-serif] font-bold leading-[16px] left-[calc(50%-64.34px)] text-[#00c2b8] text-[12px] text-nowrap top-[-0.8px] tracking-[1.2px] whitespace-pre">AUTHORITY SCORE</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="h-[96px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="[text-shadow:rgba(50,255,4,0.15)_0px_4px_60px,rgba(4,11,23,0.3)_0px_10px_25px] absolute font-['Satoshi:Bold',sans-serif] leading-[96px] left-0 not-italic text-[#defcd7] text-[96px] text-nowrap top-[5px] tracking-[-4.8px] whitespace-pre">89</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.988px] relative shrink-0 w-[34.813px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[15.988px] relative w-[34.813px]">
        <p className="absolute font-['Manrope:SemiBold',sans-serif] font-semibold leading-[16px] left-0 text-[#00c2b8] text-[12px] text-nowrap top-[-0.8px] whitespace-pre">+4.2%</p>
      </div>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_2080_310)" id="Icon" opacity="0.7">
          <path d={svgPaths.p3e7757b0} id="Vector" stroke="var(--stroke-0, #C4E5E3)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M6 8V6" id="Vector_2" stroke="var(--stroke-0, #C4E5E3)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M6 4H6.005" id="Vector_3" stroke="var(--stroke-0, #C4E5E3)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_2080_310">
...
function Container3() {
  return (
    <div className="bg-[rgba(0,194,184,0.1)] box-border content-stretch flex gap-[8px] h-[25.587px] items-center pl-[12.8px] pr-[0.8px] py-[0.8px] relative rounded-[2.68435e+07px] shrink-0 w-[100.412px]" data-name="Container">
...
function Container6() {
  return (
    <div className="box-border content-stretch flex gap-[12px] items-center px-0 py-[6px] relative shrink-0 w-full" data-name="Container">
      <Icon2 />
      <p className="[text-shadow:rgba(240,241,244,0.15)_0px_4px_60px,rgba(4,11,23,0.4)_0px_10px_25px] font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#fcfcfc] text-[30px] text-nowrap whitespace-pre">Authority Trusted</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col h-[48px] items-start justify-center relative shrink-0 text-nowrap whitespace-pre" data-name="Container">
      ...
      <p className="font-['Satoshi:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[16px] text-white">avonetiqxsribu.com</p>
    </div>
  );
}
...
function InfoItem() {
  return (
    <div className="relative shrink-0" data-name="Info Item">
...
function InfoItem1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Info Item">
...
function Container9() {
  return <div className="bg-[rgba(255,255,255,0.05)] h-[40px] shrink-0 w-px" data-name="Container" />;
}

function InfoItem2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 text-nowrap whitespace-pre" data-name="Info Item">
...
function BrandContext() {
  return (
    <div className="bg-[rgba(22,46,62,0.7)] box-border content-stretch flex flex-col items-start p-[16px] relative rounded-[14px] shrink-0" data-name="BrandContext">
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex gap-[64px] items-center left-[361.35px] top-[145px]">
      <Container5 />
      <InfoContainer />
    </div>
  );
...
function Container11() {
  return (
    <div className="content-stretch flex gap-[8px] h-[16px] items-center relative shrink-0" data-name="Container">
      <Icon5 />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#00c2b8] text-[14px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">OPTIMIZE</p>
    </div>
  );
}
...
function CardTestimoni() {
  return (
    <div className="bg-[rgba(22,36,62,0.5)] h-[48px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="Card - Testimoni">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] h-[48px] items-start justify-center px-[20px] py-[16px] relative w-full">
          <Container11 />
        </div>
      </div>
    </div>
...
function ScoreContainer() {
  return (
    <div className="content-stretch flex font-['Satoshi:Bold',sans-serif] items-end not-italic relative shrink-0" data-name="Score Container">
...
function CardContent() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] items-start pb-0 pt-[8px] px-0 relative shrink-0 text-nowrap whitespace-pre" data-name="Card Content">
      <ScoreContainer />
...
function DetailItem() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
...
function DetailItem2() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px]">CWV Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-white">67</p>
    </div>
  );
}
...
function DetailItem3() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px]">Schema Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-white">67</p>
    </div>
  );
}
...
function DetailsContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full" data-name="Details Container">
      <Frame5 />
  ...
  return (
    <div className="bg-[rgba(22,36,62,0.5)] relative rounded-bl-[12px] rounded-br-[12px] shrink-0 w-full" data-name="Card - Testimoni">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-center px-[20px] py-[16px] relative w-full">
          <Frame1 />
        </div>
      </div>
    </div>
...
function Container13() {
  return (
    <div className="content-stretch flex gap-[8px] h-[16px] items-center relative shrink-0" data-name="Container">
      <Icon6 />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#c6f558] text-[14px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">MANIFEST</p>
    </div>
  );
}
...
function ScoreContainer1() {
  return (
    <div className="content-stretch flex font-['Satoshi:Bold',sans-serif] items-end not-italic relative shrink-0" data-name="Score Container">
      <p className="leading-[40px] relative shrink-0 text-[36px] text-white">78</p>
      <p className="leading-[32px] relative shrink-0 text-[#919eab] text-[24px]">/100</p>
    </div>
  );
}
...
function DetailItem6() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px]">Backlink Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-white">67</p>
    </div>
  );
}
...
function DetailItem7() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px]">News Mention Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-white">67</p>
    </div>
  );
}
...
function DetailItem8() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px]">Wikidata Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-white">67</p>
    </div>
  );
}
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2080_299)" id="Icon">
          <path d={svgPaths.p19aa0680} id="Vector" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2b561900} id="Vector_2" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p35abdf80} id="Vector_3" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3fe85180} id="Vector_4" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M1.33333 10.6667H1.34" id="Vector_5" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p32d5a6be} id="Vector_6" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p5096bc0} id="Vector_7" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2a7a680} id="Vector_8" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p12c93300} id="Vector_9" stroke="var(--stroke-0, #F8B400)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
          <clipPath id="clip0_2080_299">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function Container16() {
  return (
    <div className="content-stretch flex gap-[8px] h-[16px] items-center relative shrink-0" data-name="Container">
      <Icon7 />
      <p className="font-['Manrope:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#f8b400] text-[14px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">GENERATIVE</p>
    </div>
  );
}
...
function ScoreContainer2() {
  return (
    <div className="content-stretch flex font-['Satoshi:Bold',sans-serif] items-end not-italic relative shrink-0" data-name="Score Container">
      <p className="leading-[40px] relative shrink-0 text-[36px] text-white">93</p>
      <p className="leading-[32px] relative shrink-0 text-[#919eab] text-[24px]">/100</p>
    </div>
  );
}
...
function DetailItem11() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px]">AI Cite Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-white">67</p>
    </div>
  );
}
...
function DetailItem12() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 w-full" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px] w-[173px]">AI Overview Appearance</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">67</p>
    </div>
  );
}
...
function DetailItem13() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[normal] relative shrink-0 w-full" data-name="Detail Item">
      <p className="font-['Manrope:Regular',sans-serif] font-normal relative shrink-0 text-[#a7a7a7] text-[14px] w-[173px]">Authority Sources Score</p>
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">67</p>
    </div>
  );
}
...
function Card() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-1/2 top-[470px] translate-x-[-50%] w-[871px]" data-name="Card">
      <Frame />
      <Frame2 />
      <Frame15 />
    </div>
...
function Logo() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[68.865px]" data-name="Logo">
      <Group2 />
...
function DashboardHeader() {
  return (
    <div className="absolute bg-[rgba(12,25,44,0.75)] box-border content-stretch flex h-[85px] items-center justify-between left-1/2 px-[60px] py-[20px] top-0 translate-x-[-50%] w-[1440px]" data-name="DashboardHeader">
...
export default function Avq() {
  return (
    <div className="bg-[#0c192c] relative size-full" data-name="AVQ">
      <Pattern />
      <Shade />
      <Shade1 />
      <Frame10 />
